...
int fm_core_copy_or_move(
    ...
    if (is_cut) {
        ...
        {
            std::lock_guard<std::mutex> lock(core->impl.stack_mutex);
...
int fm_core_undo(FmCore* core, char** error_message) {
    ...
    FmCoreImpl::UndoEntry undo;
    {
        ...
        undo = std::move(core->impl.undo_stack.back());
...
int fm_core_redo(FmCore* core, char** error_message) {
    ...
    FmCoreImpl::UndoEntry redo;
    {
        ...
        redo = std::move(core->impl.redo_stack.back());
